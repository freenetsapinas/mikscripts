...
wget -O /bin/proxy3.py https://raw.githubusercontent.com/freenetsapinas/mikscripts/main/proxy3 -q
...
echo -e "#       Server System: WhiteMask             #"
...
EOM
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/mikscripts/main/prem.sh -q
}
